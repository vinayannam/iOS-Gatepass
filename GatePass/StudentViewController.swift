...
class StudentViewController: UICollectionViewController,UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        refresher.addTarget(self, action: #selector(loadData), for: .allEvents)
        ...
        let formButton:UIButton = {
            ...
            textView.translatesAutoresizingMaskIntoConstraints = false
            textView.addTarget(self, action: #selector(form), for: .touchUpInside)
            return textView
        ...
        let img1:UIImageView = {
            ...
            imgV.image = #imageLiteral(resourceName: "ic_note_add_3x")
        ...
        formButton.addSubview(img1)
        
        formButton.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[v0]-10-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":img1]))
        formButton.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-10-[v0]-10-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":img1]))
        ...
        self.view.addSubview(formButton)
        self.view.addSubview(logoutButton)

        
        self.view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-20-[v0]-10-[v1(50)]-10-[v2(50)]-20-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":titleView,"v1":formButton,"v2":logoutButton]))
        ...
        self.view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-30-[v0(50)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":formButton]))
        ...
        collectionView?.register(PassCell.self, forCellWithReuseIdentifier: cellId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let pass: PassCell
        pass = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! PassCell
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
         ...
         if(pass.p_request == true && pass.w_request == true){
